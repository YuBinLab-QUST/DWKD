...
parser.add_argument('--pretrained_model_name', type=str, default="model_best_loss.pt", help='pretrained model name')
...
parser.add_argument('--pretrained_dir', type=str,
                    default='./pretrained_models/2020/MUnetKD16-32_fold-1_0.2_CE0.8_en0.2_5',
...
parser.add_argument('--dy_loss', action='store_true', help='uncertainty mode')
...
if __name__ == '__main__':
    ...
    fea_hooks = get_feas_by_hook(student_model.student)
    # fea_hooks = get_feas_by_hook(student_model)
    targets = []
    feas = []
    intersections = torch.zeros((96, 3)).cuda()
    unions = torch.zeros((96, 3)).cuda()
